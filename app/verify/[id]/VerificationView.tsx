...
import { ArrowLeft, CalendarDays, FileCheck2, LoaderCircle, MapPinned, Phone, ShieldCheck, ShieldX } from 'lucide-react';
...
type Reference = { ref_number: string; subject?: string | null; issue_date?: string | null; surveys?: Survey | null };
